...
argp.version('1.0.0')
	...
	.option('-t, --timeout <tout>', 'timeout in milliseconds of inactivity on the socket', 300)
...
ed = parseInt((argp.ports.split("-").length == 1)? argp.ports.split("-")[0] : argp.ports.split("-")[1]);
...
var scanPorts = function(lsts, callback){
